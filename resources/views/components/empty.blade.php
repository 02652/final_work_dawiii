<div class="text-center">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 300" data-imageid="full-inbox-0"
        imageName="Empty Inbox" class="illustrations_image w-auto h-56 mx-auto text-black sm:h-64"
        style="width: 271px;">
        <g id="_296_empty_inbox_outline" data-name="#296_empty_inbox_outline">
            ...
            <path
                ...
                fill="#093f68" />
            <path d="M241.81,194.5h7.66v2.3h-5.18v2.1h4.89v2.29h-4.89v2.3h5.46v2.29h-7.94Z"
                fill="#093f68" />
            <path
    ...
    <p class="mt-4 text-gray-500">{{ $slot }}</p>
</div>